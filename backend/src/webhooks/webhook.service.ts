...
export class NotificationService {
  ...
  async startCampaign(provider: 'acuity' | 'square', integration: any, payload: any, gapletSlotId?: string) {
    ...
    // ---------- RANDOMIZER: reemplaza el sort por un shuffle ----------
    ...
    const notifyList = shuffleInPlace(eligibleRecipients.slice());
    ...
    console.log(`🚀 Started notification campaign ${campaignId} for user ${userId}`);
  }

  ...
  <li className="flex items-start gap-3">
    ...
    {preferences ? (
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-12">
        ...
        <StatCard label="Recovery Rate" value={`${(userInfo?.totalReplacements/(userInfo?.totalCancellations || 1)) * 100 || 0}%`} icon={<TrendingUp className="w-6 h-6 text-green-500" />} color="border-l-green-500" />

    ...
    <section className="relative isolate overflow-hidden min-h-screen bg-white flex flex-col items-center justify-center px-4 sm:px-8 ">
      ...
      <div className="lg:mr-84 z-10 flex flex-col lg:flex-row items-start justify-start gap-82 lg:gap-0">
        ...
        <div className="text-center max-w-xl lg:mr-40">
          <h1 className="text-[36px] sm:text-4xl font-bold mb-6">
            Appointment waitlist automation — auto‑fill last‑minute cancellations
          </h1>
          <p className="text-md text-gray-600 mb-6">
            Gaplets detects openings on Square Appointments, messages eligible clients via SMS/Email, and auto‑books the first to confirm — turning empty slots into revenue.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="#Demo">
              <GlowButton variant="secondary">See live demo (30s)</GlowButton>
            </Link>
          </div>
          <p className="mt-2 text-xs text-gray-500">No credit card. Works with Square Appointments.</p>
        </div>
        ...
        <div className="flex flex-row items-center left-22 sm:left-46 -top-72 lg:-top-12 lg:left-22 relative justify-center scale-55 md:scale-75 lg:scale-95">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 scale-[2.25] -z-5">
            <svg width="100%" height="200" viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M10 100 C 150 0, 350 200, 590 100" stroke="#2e2e2e" strokeWidth="6" strokeDasharray="12 12" fill="none" strokeLinecap="round" />
            </svg>
          </div>
          ...
          <div className="absolute top-18 right-28 bg-white p-6 rounded-xl shadow-2xl border border-gray-200 h-48 w-56 animate-fadeIn">
            <div className="flex items-start flex-col">
              ...
              <div className="text-left">
                <p className="text-md text-gray-800 font-semibold mb-2">Appointment cancellation detected</p>
                <p className="text-sm text-gray-600 font-normal">3:00 PM with Dr. Roberts is now available.</p>
              </div>
            </div>
          </div>
          ...
          <div className="absolute top-62 left-36 bg-white p-6 rounded-xl shadow-2xl border border-gray-200 h-48 w-56 animate-fadeIn ">
            <div>
              <div className="flex flex-col items-start gap-3">
                <p className="text-md font-bold text-gray-800">Notification sent to 8 eligible clients</p>
                <p className="text-xs text-gray-500 leading-relaxed">
                  Gaplets selects clients based on availability, service match, and past reliability, then notifies them via SMS/Email.
                </p>
              </div>
